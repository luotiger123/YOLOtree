...
model = YOLO("path/to/YOLOTree.pt")  # Load a custom trained model
...
yolo track model=path/to/YOLOTree.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/YOLOTree.pt tracker="bytetrack.yaml"
```
